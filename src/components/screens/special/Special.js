        ...
        <>
          ...
          {shape === '1' && (
            <div>
              <p>בחרי מספר קומות:</p>
              <div>
                <input type="radio" name="layers" value="1" onChange={(e) => setLayers(e.target.value)} />
                <label>1</label>
              </div>
              <div>
                <input type="radio" name="layers" value="2" onChange={(e) => setLayers(e.target.value)} />
                <label>2</label>
              </div>
              <div>
                <input type="radio" name="layers" value="3" onChange={(e) => setLayers(e.target.value)} />
                <label>3</label>
              </div>
            </div>
          )}
