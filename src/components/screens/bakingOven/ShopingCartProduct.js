...
export default function ShopingCartProduct(props) {
  ...
  const handleReduceFromCart = () => {
    dispatch(reduceFromCart(props.id));
  };
    ...
    <div className="card mb-4 shadow-sm w-100">
      <div className="row g-0 align-items-center">
        ...
        <div className="col-md-3 text-end pe-4">
          <button className="btn btn-outline-danger btn-sm mb-2 w-100" onClick={handleRemoveFromCart}>
            הסר לגמרי
          </button>
          <button className="btn btn-outline-warning btn-sm w-100" onClick={handleReduceFromCart}>
            הפחת כמות
          </button>
        </div>
